...
const T = {
  ...
  en: {
    ...
    heroSub: 'A place where men who love Japan meet Japanese women.',
    ...
    womenTitleLine1: 'To him who loves Japan,',
    womenTitleLine2: 'show him the real Japan.',
    ...
    step3Body: 'Time together expands both of your worlds.',
    ...
    feature2Body: 'Japanese, English, Korean, Taiwanese (Traditional Chinese). Feelings translate themselves.',
    feature3Title: 'Built-in Translation',
    feature3Body: 'Preview your message before sending. Your words, delivered naturally. And as you chat, you pick up the language too.',
    feature4Title: 'Authentic Japan',
    feature4Body: 'Your love of Japan is where the connection begins.',
  ...
  ko: {
    ...
    menSub: '하나의 만남에서, 수많은 일본이 보이기 시작해요.',
    menBody: '관광지에서는 만날 수 없는 일본이 있습니다. 현지 음식, 조용한 신사, 일상의 풍경. 그녀와 함께이기에 처음으로 보이는 것들이 있습니다.',
    menCta: '시작하기',
    womenTag: '일본인 여성 분들께',
    womenTitleLine1: '일본을 사랑해준 그에게,',
    womenTitleLine2: '진짜 일본을 알려주고 싶다.',
    ...
    step2Title: '만남 찾기',
    step2Body: '일본을 사랑하는 해외 남성과 일본인 여성이 만나는 곳.',
    step3Title: '진짜 일본 체험하기',
    step3Body: '함께하는 시간이, 서로의 세계를 넓혀간다.',
    whyTitle: '진짜 일본은 진짜 만남에서 시작됩니다.',
    whySubtitle: '일본 문화를 사랑하는 유럽·미국·대만·한국 등 해외 남성과 일본인 여성을 위한 만남의 장입니다.',
    featureJpTitle: '일본 현지 운영',
    featureJpBody: '일본 회사가 일본인에 의해 운영하는 사이트입니다. 안심하고 이용하실 수 있습니다.',
    feature1Title: '안심 · 안전',
    feature1Body: 'AI 심사로 신원 확인. 안심하고 만날 수 있는 환경.',
    feature2Title: '4개 언어 지원',
    feature2Body: '일본어·영어·한국어·대만어（번체）지원. 언어가 달라도 마음은 전해집니다.',
    feature3Title: '번역 기능 내장',
    feature3Body: '메시지 전송 전 번역 확인. 당신의 말을 자연스럽게 전달하세요. 대화하면서 언어도 자연스럽게 익혀집니다.',
    feature4Title: '문화 교류',
    feature4Body: '당신이 좋아하는 일본에서, 만남이 시작된다.',
  ...
  'zh-tw': {
    ...
    menCta: '立即開始',
    womenTag: '日本女性',
    womenTitleLine1: '對那個愛上日本的他，',
    womenTitleLine2: '讓他認識真正的日本。',
    ...
    step3Title: '體驗真實的日本',
    step3Body: '兩人共度的時光，將拓展彼此的世界。',
    whyTitle: '真實的日本，從真實的相遇開始。',
    whySubtitle: '為熱愛日本文化的歐美、台灣、韓國等海外男性與日本女性而打造的相遇之所。',
    featureJpTitle: '日本人營運',
    featureJpBody: '由日本公司、日本人營運的網站。讓您安心使用。',
    feature1Title: '安心・安全',
    feature1Body: 'AI審核身份驗證。為您打造安心的相遇環境。',
    feature2Title: '4種語言支援',
    feature2Body: '日語・英語・韓語・台灣語（繁體）。語言不同，心意自然傳達。',
    feature3Title: '內建翻譯功能',
    feature3Body: '傳送前確認翻譯。用你自己的話傳達心意。在對話中，語言也自然而然地學會了。',
    feature4Title: '文化交流',
    feature4Body: '從你熱愛的日本出發，相遇由此開始。',
    planTitle: '開始你的日本故事。',
    planFree: '女性永久免費。',
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden"
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        {/* CTAボタン */}
        <div className="flex flex-col items-center mt-12 animate-fade-up animate-delay-600">
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-start">
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs mt-2 text-center" style={{ color: 'var(--color-usuzumi)' }}>
                {t.womenOnlyNotice}
              </p>
            </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <div className="flex flex-col items-center gap-1">
            ...
            <p className="font-shippori text-xs text-white/40">
              {t.ctaNote}
            </p>
          </div>
          <div className="flex flex-col items-center">
